...
function Register() {
  ...
  const { notRegisterMessage } = useSelector(state => state.auth)
                ...
                <div className="card z-index-0">
                  ...
                  <div className="card-body">
                    <form >
                      <div className="mb-3">
                        <input
                          type="text" className="form-control" placeholder="Name" aria-label="Name" aria-describedby="email-addon"
                          value={name}
                      ...
                      <div className="text-center">
                        <button onClick={handlerRegister} type="button" className="btn bg-gradient-dark w-100 my-4 mb-2">Sign up</button>
                      </div>
